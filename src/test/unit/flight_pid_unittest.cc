...
static union attitude_euler_angles att = {0};
...
TEST(PIDUnittest, TestPidLuxFloat)
{
    ...
    anglerate_set_configs(&default_controller, pidProfile, &controlRate, max_angle_inclination, &rollAndPitchTrims, &rxConfig);

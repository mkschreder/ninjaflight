...
/*
 * Authors:
 * Dominic Clifton - Serial port abstraction, Separation of common STM32 code for ninjaflight, various cleanups.
...
static void uartSetMode(serialPort_t *instance, portMode_t mode)
{
    uartPort_t *uartPort = (uartPort_t *)instance;

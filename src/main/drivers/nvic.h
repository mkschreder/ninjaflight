...
#define NVIC_PRIO_TIMER                    NVIC_BUILD_PRIORITY(2, 1)
#define NVIC_PRIO_BARO_EXT                 NVIC_BUILD_PRIORITY(0x0f, 0x0f)
#define NVIC_PRIO_WS2811_DMA               NVIC_BUILD_PRIORITY(2, 2)  // TODO - is there some reason to use high priority? (or to use DMA IRQ at all?)
#define NVIC_PRIO_TRANSPONDER_DMA          NVIC_BUILD_PRIORITY(3, 0)
#define NVIC_PRIO_SERIALUART1_TXDMA       NVIC_BUILD_PRIORITY(2, 1)
#define NVIC_PRIO_SERIALUART1_RXDMA       NVIC_BUILD_PRIORITY(2, 1)
#define NVIC_PRIO_SERIALUART1             NVIC_BUILD_PRIORITY(2, 1)
#define NVIC_PRIO_SERIALUART2_TXDMA       NVIC_BUILD_PRIORITY(2, 0)
#define NVIC_PRIO_SERIALUART2_RXDMA       NVIC_BUILD_PRIORITY(2, 1)
#define NVIC_PRIO_SERIALUART2             NVIC_BUILD_PRIORITY(2, 2)
#define NVIC_PRIO_SERIALUART3_TXDMA       NVIC_BUILD_PRIORITY(2, 0)
#define NVIC_PRIO_SERIALUART3_RXDMA       NVIC_BUILD_PRIORITY(2, 1)
#define NVIC_PRIO_SERIALUART3             NVIC_BUILD_PRIORITY(2, 2)
#define NVIC_PRIO_SERIALUART4_TXDMA       NVIC_BUILD_PRIORITY(2, 0)
#define NVIC_PRIO_SERIALUART4_RXDMA       NVIC_BUILD_PRIORITY(2, 1)
#define NVIC_PRIO_SERIALUART4             NVIC_BUILD_PRIORITY(2, 2)
#define NVIC_PRIO_SERIALUART5_TXDMA       NVIC_BUILD_PRIORITY(2, 0)
#define NVIC_PRIO_SERIALUART5_RXDMA       NVIC_BUILD_PRIORITY(2, 1)
...
#define NVIC_PRIO_USB_WUP                  NVIC_BUILD_PRIORITY(2, 0)
